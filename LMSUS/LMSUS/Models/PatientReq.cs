...
{
    public partial class PatientReq
    {
        public PatientReq()
        {
            PatCyto = new HashSet<PatCyto>();
            PatientReqAddnBillInfo = new HashSet<PatientReqAddnBillInfo>();
            PatientReqBillTests = new HashSet<PatientReqBillTests>();
            PatientReqDiag = new HashSet<PatientReqDiag>();
            PatientReqDocuments = new HashSet<PatientReqDocuments>();
            PatientReqOtherInfo = new HashSet<PatientReqOtherInfo>();
            PatientReqTest = new HashSet<PatientReqTest>();
        }
        ...
        public string RecentAddTestsCodes { get; set; }
        public string RecentDeletedTestsCodes { get; set; }
        public bool? AutoFax { get; set; }
        public DateTime? MachineRportDate { get; set; }

        public Patient Pa { get; set; }
        public Pathologist Pat { get; set; }
        public RefDoctor PreDoc { get; set; }
        public ICollection<PatCyto> PatCyto { get; set; }
        public ICollection<PatientReqAddnBillInfo> PatientReqAddnBillInfo { get; set; }
        public ICollection<PatientReqBillTests> PatientReqBillTests { get; set; }
        public ICollection<PatientReqDiag> PatientReqDiag { get; set; }
        public ICollection<PatientReqDocuments> PatientReqDocuments { get; set; }
        public ICollection<PatientReqOtherInfo> PatientReqOtherInfo { get; set; }
        public ICollection<PatientReqTest> PatientReqTest { get; set; }
    }
}
